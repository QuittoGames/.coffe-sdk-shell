...
if [[ "$DEBUG" == "true" ]]; then
    ...
    print -P "  ${ICON_SHELL}  ${CLR_DIM}Shell:${CLR_RESET}  search env git docker"
...
coffe() {
    ...
    case "$cmd" in
        ...
        *)
            ...
            print -P "  ${ICON_SEARCH} Try: ${CLR_DIM}coffe <search|search-in|env|git|docker|packages|version>${CLR_RESET}" >&2
            return 1
            ;;
    esac
}
